...
public class PrivateMethodTester {
     ...
     */
    public Object invokePrivate(String name, Object... parameters) throws Throwable {
     ...
     * @return the result of invoking the named private method with the given parameters.
     */
    public Object invokePrivateExplicit(String name, Class<?>[] classes, Object... parameters) throws Throwable {
    ...
    private Object findAndInvokePrivateMethod(String name, Class<?>[] classes, Object[] parameters, boolean allowSubstitutions) throws Throwable {
        try {
    ...
    private Object invokePrivateMethod(Method m, Object[] parameters) throws Throwable {
        try {
            if (m != null) return m.invoke(object, parameters);
